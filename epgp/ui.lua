...
local function CreateEPGPFrame()
  ...
  t:SetTexture("Interface\\AddOns\\epgp\\images\\tyan")
  t:SetWidth(60)
  t:SetHeight(60)
  ...
  t:SetText("EPGP Not So Bad Edition by Веос")
...
local function AddGPControls(frame)
  ...
  reasonLabel:SetText("Снять ЕП за шмотку")
...
local function AddEPControls(frame, withRecurring)
  local reasonLabel =
    frame:CreateFontString(nil, "ARTWORK", "GameFontHighlightSmall")
  reasonLabel:SetText("Снять ЕП по причине")
  reasonLabel:SetPoint("TOPLEFT")
